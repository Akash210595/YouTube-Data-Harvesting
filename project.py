...
st.set_page_config(page_title= " YouTube Data Analysis | By Akash",page_icon= "🧮",layout='wide',
    initial_sidebar_state="expanded",menu_items={'About': """# This app is created by Akash!"""})
# steamlit menu bar
